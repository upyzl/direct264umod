...
#endif
{
	...
	__asm {
		mov  eax, src
		movdqu  xmm1, [eax-FDEC_STRIDE-1]
		movdqa  xmm0, [eax-FDEC_STRIDE+8]
		pmaddwd xmm0, [eax-FDEC_STRIDE-8]
		pmaddwd xmm1, pb_12345678
		paddd   xmm0, xmm1
		movhlps xmm1, xmm0
		paddd   xmm0, xmm1
	...
	__asm {
		...
		movq mm0, [eax-FDEC_STRIDE+8]
		palignr   mm1, [eax-FDEC_STRIDE-8], 7
		pmaddubsw mm0, pb_12345678
		pmaddubsw mm1, pb_m87654321
		paddw  mm0, mm1
		pshufw mm1, mm0, 14
		paddw  mm0, mm1
		pshufw mm1, mm0, 1
