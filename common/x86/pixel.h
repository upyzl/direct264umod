...
DECL_X4( sad, sse3 )
DECL_X4( sad, ssse3 )
DECL_PIXELS( int, ssd, mmx, ( pixel *, intptr_t, pixel *, intptr_t, intptr_t ) )
DECL_PIXELS( int, ssd, mmx2, ( pixel *, intptr_t, pixel *, intptr_t, intptr_t ) )
DECL_PIXELS( int, ssd, sse2slow, ( pixel *, intptr_t, pixel *, intptr_t, intptr_t ) )
DECL_PIXELS( int, ssd, sse2, ( pixel *, intptr_t, pixel *, intptr_t, intptr_t ) )
DECL_PIXELS( int, ssd, ssse3, ( pixel *, intptr_t, pixel *, intptr_t, intptr_t ) )
DECL_PIXELS( int, ssd, avx, ( pixel *, intptr_t, pixel *, intptr_t, intptr_t ) )
DECL_PIXELS( int, ssd, xop, ( pixel *, intptr_t, pixel *, intptr_t, intptr_t ) )
DECL_PIXELS( int, noise, mmx2, ( pixel *, intptr_t ) )
DECL_X1( satd, mmx2 )
DECL_X1( satd, sse2 )
DECL_X1( satd, ssse3 )
DECL_X1( satd, sse4 )
