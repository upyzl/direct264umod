...
DECL_X4( sad, sse3 )
DECL_X4( sad, ssse3 )
DECL_PIXELS( int, ssd, mmx, ( pixel *, int, pixel *, int, int ) )
DECL_PIXELS( int, ssd, mmx2, ( pixel *, int, pixel *, int, int ) )
DECL_PIXELS( int, ssd, sse2slow, ( pixel *, int, pixel *, int, int ) )
DECL_PIXELS( int, ssd, sse2, ( pixel *, int, pixel *, int, int ) )
DECL_PIXELS( int, ssd, ssse3, ( pixel *, int, pixel *, int, int ) )
DECL_PIXELS( int, ssd, avx, ( pixel *, int, pixel *, int, int ) )
DECL_PIXELS( int, noise, mmx2, ( pixel *, int ) )
DECL_X1( satd, mmx2 )
DECL_X1( satd, sse2 )
DECL_X1( satd, ssse3 )
DECL_X1( satd, sse4 )
