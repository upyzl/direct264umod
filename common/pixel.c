...
static int x264_pixel_noise_##lx##x##ly( pixel *pix, int i_stride ) \
{\
    int score = 0;\
    for( int y = 0; y < ly; y++ ){\
        if( y+1 < ly ){\
...
static int x264_pixel_nssd_##lx##x##ly##nssdname( pixel *pix1, int i_stride_pix1, \
                                                  pixel *pix2, int i_stride_pix2, int weight ) \
{\
